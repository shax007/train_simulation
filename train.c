...
glVertex2f(920,300);
glEnd();
glColor3f(101.0,168.0,196.0);
     glRasterPos2f(785,370);
     board("KR Puram");

glColor3f(101.0,168.0,196.0);
     glRasterPos2f(785,340);
     board("To");
glColor3f(101.0,168.0,196.0);
     glRasterPos2f(785,310);
     board("Tc Palya");
...
int c_menu;
    ...
    printf("--------------------------------------------------------------------------------");
    printf("ARRIVAL AND DEPARTURE OF TRAIN  -By Shashank And Ashwin Suresh                        ");
    printf("--------------------------------------------------------------------------------");
